<?php
namespace ElementorEmbedVimeoShowcase\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'elementor-embed-vimeo-showcase' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'elementor-embed-vimeo-showcase' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Showcase ID', 'elementor-embed-vimeo-showcase' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Showcase ID', 'elementor-embed-vimeo-showcase' ),
			]
		);
